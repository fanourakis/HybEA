...
from structure_model.model.knowformer_encoder import Embeddings
from structure_model.model.knowformer_encoder import Encoder
from structure_model.utils.tools import truncated_normal_init
from structure_model.utils.tools import norm_layer_init
...
class Knowformer(nn.Module):
    def __init__(self, config, args=None):
        ...
        self.ele_embedding = Embeddings(self._emb_size, self._voc_size, self._initializer_range, args)

        
        ####### for ablation study on our position embedding #######
        # self.abs_pos_embedding = Embeddings(self._emb_size, 40, self._initializer_range, args)
        ############################################################
