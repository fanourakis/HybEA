...
import copy
import math
from structure_model.utils.tools import truncated_normal_init, name_init
from structure_model.utils.tools import truncated_normal
from structure_model.utils.tools import norm_layer_init
from structure_model.utils.tools import device
from structure_model.Param import RANDOM_INITIALIZATION
...
class Embeddings(nn.Module):
    def __init__(self, d_model, vocab, initializer_range, args):
        ...
        if RANDOM_INITIALIZATION:
            ...
            name_init(self.lut, [vocab, d_model], initializer_range, "1", args)
