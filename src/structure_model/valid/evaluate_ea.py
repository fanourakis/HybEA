...
def sim(embed1, embed2, metric='inner', normalize=False, csls_k=CSLS):
    """
...
def ea_evaluation(embeds1, embeds2, mapping, top_k, threads_num, metric='inner', normalize=False, csls_k=CSLS,
                  accurate=True):
    
    if mapping is None:
        alignment_rest_12, hits1_12, mr_12, mrr_12, msg, sim_mat = greedy_alignment(embeds1, embeds2, top_k, threads_num,
                                                                           metric, normalize, csls_k, accurate)
        sim_mat_2 = sim(embeds2, embeds1, metric=metric, normalize=normalize, csls_k=csls_k)
    ...
    return alignment_rest_12, hits1_12, mrr_12, msg, sim_mat, sim_mat_2
